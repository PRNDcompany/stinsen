...
public struct UIKitPresentation<ViewController: UIViewController>: UIKitPresentationType {
    ...
    public typealias MakeUIViewControllerHandler = (_ content: AnyView, _ dissmissHandler: @Sendable @escaping () -> Void) -> ViewController
    ...
    public func makeViewController<Content>(content: Content) -> UIViewController where Content : View {
        ...
        let viewController = makeUIViewController(AnyView(content), { @MainActor in
